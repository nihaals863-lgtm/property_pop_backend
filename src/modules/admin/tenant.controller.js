...
exports.deleteTenant = async (req, res) => {
    try {
        ...
        await prisma.$transaction(async (tx) => {
            ...
            // 2. Complex Cleanup (Hierarchical dependencies)
            
            // A. Invoices & Transactions
            ...
            // C. Direct References
            await tx.billingdetail.deleteMany({ where: { userId: id } });
            ...
            await tx.refundadjustment.deleteMany({ where: { tenantId: id } });
